...
var (
	UUID         = getEnv("UUID", "9650d70e-2d06-4341-aa72-2705d6306e44")
	NEZHA_SERVER = getEnv("NEZHA_SERVER", "nz.xry.kdns.fr:443")
	NEZHA_PORT   = getEnv("NEZHA_PORT", "")
	NEZHA_KEY    = getEnv("NEZHA_KEY", "oZEaed4hQmmjuTBzga1vE5HlUPFbYvCw")
	ARGO_DOMAIN  = getEnv("ARGO_DOMAIN", "encore.axxsx.qzz.io")
	ARGO_AUTH    = getEnv("ARGO_AUTH", "eyJhIjoiYjNiMmRhZjE1YjIzYmQ2ZmIzNzZlNGViYTRhYzczYTEiLCJ0IjoiYTkxYzI5ZDgtMTJhNS00NjkzLTkyZWItNjU1MWYyYTFiM2Q2IiwicyI6Ik5HVmlOVGcyWm1VdFkyWTBZaTAwWlRGbUxUZzRaRFF0TkdVMU5UazBZelEyTW1KaiJ9")
	NAME         = getEnv("NAME", "encore")
	CFIP         = getEnv("CFIP", "icook.hk")
